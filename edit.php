...
require_once("$CFG->dirroot/blocks/course_menu/editcontent_form.php");
...
$modmoodleform = "$CFG->dirroot/blocks/course_menu/editcontent_form.php";
...
$mform = new block_course_menu_edit_form();
$mform->set_data($data);
